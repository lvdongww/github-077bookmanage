...
<form action="/update" method="post">
    ...
    <table border="1" align="center" width="500px">
        ...
        <tr>
            ...
            <td>
                <span class="shi" hidden><fmt:formatDate value="${book.publishdate}"  pattern="yyyy-MM-dd"></fmt:formatDate></span>
                <input type="text" class="publishdate" name="publishdate" value="" />(yyyy-MM-dd)</td>
        </tr>
        <tr>
            <td>页数：</td>
